insert into author (name, bio, img_url, is_active) values ('Martha Hunt', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.

Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', 'http://dummyimage.com/118x119.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Frances Powell', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', 'http://dummyimage.com/174x117.jpg/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Nicole Murphy', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.

Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', 'http://dummyimage.com/180x217.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Susan Taylor', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.

Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'http://dummyimage.com/181x127.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Joshua Harris', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', 'http://dummyimage.com/181x208.bmp/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Samuel Cooper', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', 'http://dummyimage.com/223x190.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Michelle Cooper', 'Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.', 'http://dummyimage.com/198x152.bmp/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Lisa Jenkins', 'Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.

In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.', 'http://dummyimage.com/121x158.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Frank Campbell', 'Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.

Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.', 'http://dummyimage.com/161x178.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Rachel Meyer', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 'http://dummyimage.com/149x225.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Dennis Fuller', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.

Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'http://dummyimage.com/152x214.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Phillip Tucker', 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.

Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', 'http://dummyimage.com/213x229.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Laura Stephens', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 'http://dummyimage.com/165x116.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jimmy Jackson', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', 'http://dummyimage.com/213x147.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Sharon Williams', 'Phasellus in felis. Donec semper sapien a libero. Nam dui.

Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.', 'http://dummyimage.com/129x229.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Melissa Perez', 'Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', 'http://dummyimage.com/111x175.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Jose Kelley', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.

Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', 'http://dummyimage.com/240x229.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Cynthia Hawkins', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.

Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', 'http://dummyimage.com/227x181.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Joe Snyder', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.

Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 'http://dummyimage.com/138x207.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Frances Fuller', 'Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', 'http://dummyimage.com/240x226.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Stephen Cruz', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', 'http://dummyimage.com/100x185.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Ronald Simpson', 'In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.', 'http://dummyimage.com/243x230.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Peter Holmes', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.

Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.', 'http://dummyimage.com/206x244.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Amy Chapman', 'Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.

Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.', 'http://dummyimage.com/209x139.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Steve Fuller', 'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.

Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.', 'http://dummyimage.com/173x195.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Ryan Howard', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.

Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 'http://dummyimage.com/231x241.bmp/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Paul Harrison', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.

Sed ante. Vivamus tortor. Duis mattis egestas metus.', 'http://dummyimage.com/249x142.jpg/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('John Woods', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.

Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.', 'http://dummyimage.com/101x165.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Gerald Armstrong', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.

Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 'http://dummyimage.com/194x213.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Joan Fisher', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.

Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', 'http://dummyimage.com/137x161.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Christine Berry', 'Fusce consequat. Nulla nisl. Nunc nisl.

Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.', 'http://dummyimage.com/191x200.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Christine Barnes', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.

Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 'http://dummyimage.com/150x221.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Peter Rose', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.

Sed ante. Vivamus tortor. Duis mattis egestas metus.', 'http://dummyimage.com/109x220.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Paul Gomez', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.', 'http://dummyimage.com/127x203.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Martha Peters', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.', 'http://dummyimage.com/106x206.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Fred Butler', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.

Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 'http://dummyimage.com/146x217.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Virginia Miller', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.

Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.', 'http://dummyimage.com/126x221.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Kevin Diaz', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.

Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 'http://dummyimage.com/212x195.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Doris Hanson', 'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.

Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.', 'http://dummyimage.com/217x242.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Sean Ferguson', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', 'http://dummyimage.com/188x202.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Carl Hill', 'Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.

Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', 'http://dummyimage.com/227x187.jpg/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Denise Collins', 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.', 'http://dummyimage.com/235x139.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Brandon Willis', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.

Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', 'http://dummyimage.com/202x138.bmp/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Rebecca Harrison', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 'http://dummyimage.com/133x198.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Charles Holmes', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'http://dummyimage.com/214x248.bmp/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Aaron Clark', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', 'http://dummyimage.com/105x146.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Kenneth Austin', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', 'http://dummyimage.com/156x125.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jessica Ramos', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.

Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 'http://dummyimage.com/219x110.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Juan Warren', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.

Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', 'http://dummyimage.com/246x126.bmp/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Jane Powell', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.

Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.', 'http://dummyimage.com/238x106.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jessica Taylor', 'Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.', 'http://dummyimage.com/138x110.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jack Oliver', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 'http://dummyimage.com/200x151.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Christine Willis', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.

In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', 'http://dummyimage.com/122x101.bmp/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jimmy Stevens', 'Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.

Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.', 'http://dummyimage.com/108x240.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Edward Gonzalez', 'In congue. Etiam justo. Etiam pretium iaculis justo.', 'http://dummyimage.com/248x192.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Benjamin West', 'In congue. Etiam justo. Etiam pretium iaculis justo.', 'http://dummyimage.com/219x185.bmp/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Carolyn Allen', 'Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.', 'http://dummyimage.com/155x127.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Gary Webb', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.', 'http://dummyimage.com/229x177.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Alan Richardson', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.

Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.', 'http://dummyimage.com/176x204.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Diana Ray', 'Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem.

Fusce consequat. Nulla nisl. Nunc nisl.', 'http://dummyimage.com/216x211.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Earl Hart', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.

Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'http://dummyimage.com/120x200.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('William Lawson', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.

Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', 'http://dummyimage.com/241x148.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Bruce Dixon', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', 'http://dummyimage.com/207x233.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Karen Kelley', 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.

Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.', 'http://dummyimage.com/113x132.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jennifer Moreno', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.

In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', 'http://dummyimage.com/177x113.bmp/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Randy Ward', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.', 'http://dummyimage.com/208x209.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Heather Watson', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.

Proin interdum mauris non ligula pellentesque ultrices. Phasellus id sapien in sapien iaculis congue. Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.', 'http://dummyimage.com/161x217.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Joan Bishop', 'Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.', 'http://dummyimage.com/222x102.bmp/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Michael Patterson', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.', 'http://dummyimage.com/204x201.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Cheryl Stevens', 'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', 'http://dummyimage.com/106x105.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Gloria Green', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.

Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 'http://dummyimage.com/128x233.png/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Benjamin Hart', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.

Sed ante. Vivamus tortor. Duis mattis egestas metus.', 'http://dummyimage.com/187x199.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Paul Ray', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', 'http://dummyimage.com/226x168.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Diana Stevens', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 'http://dummyimage.com/249x230.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Scott Burke', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', 'http://dummyimage.com/118x226.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Walter Shaw', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 'http://dummyimage.com/160x123.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Carl Reyes', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', 'http://dummyimage.com/160x163.png/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Chris Spencer', 'Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.', 'http://dummyimage.com/120x238.jpg/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Gloria Ward', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.

Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.', 'http://dummyimage.com/108x105.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Lois Black', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.

In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.', 'http://dummyimage.com/110x210.bmp/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jose Robinson', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', 'http://dummyimage.com/192x169.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Patricia Payne', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.

Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 'http://dummyimage.com/154x202.bmp/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Phillip Jordan', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'http://dummyimage.com/238x198.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Jennifer Banks', 'Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', 'http://dummyimage.com/118x206.bmp/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Kathy Morales', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.', 'http://dummyimage.com/229x190.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Elizabeth Cox', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.', 'http://dummyimage.com/187x187.bmp/5fa2dd/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Earl Cole', 'Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem.', 'http://dummyimage.com/224x233.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Angela Gonzalez', 'In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.', 'http://dummyimage.com/173x150.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Peter Gibson', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.

Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.', 'http://dummyimage.com/207x197.jpg/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Donna Washington', 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.', 'http://dummyimage.com/125x250.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Joe Hicks', 'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.', 'http://dummyimage.com/144x176.png/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Sarah Greene', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.

In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.', 'http://dummyimage.com/247x212.jpg/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Wayne Hicks', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.

Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', 'http://dummyimage.com/179x105.bmp/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Rose Stone', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', 'http://dummyimage.com/165x249.jpg/cc0000/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Nancy Miller', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', 'http://dummyimage.com/241x112.jpg/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Kathryn Young', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.

Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.', 'http://dummyimage.com/168x106.png/ff4444/ffffff', true);
insert into author (name, bio, img_url, is_active) values ('Tammy Spencer', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.

Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', 'http://dummyimage.com/134x232.bmp/dddddd/000000', true);
insert into author (name, bio, img_url, is_active) values ('Bobby Wilson', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', 'http://dummyimage.com/236x170.bmp/ff4444/ffffff', true);
